...
class Login(Frame):
    ...
    def process6(self,r):  #Histogram
        ...
        if sd > 24810.00 and sd < 24850.00:
            return 1
        else:
            return 0
    ...
    def gp(self):
        img1 = cv2.imread('p1Anti A.png',0)
        cv2.imshow('Anti-A',img1)
        img2 = cv2.imread('p1Anti B.png', 0)
        cv2.imshow('Anti-B', img2)
        img3 = cv2.imread('p1Anti D.png', 0)
        cv2.imshow('Anti-D', img3)
        img4 = cv2.imread('p1Control.png', 0)
        cv2.imshow('Control', img4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()

    def autothresh(self):
        img1 = cv2.imread('p2Anti A.png', 0)
        cv2.imshow('Anti-A', img1)
        img2 = cv2.imread('p2Anti B.png', 0)
        cv2.imshow('Anti-B', img2)
        img3 = cv2.imread('p2Anti D.png', 0)
        cv2.imshow('Anti-D', img3)
        img4 = cv2.imread('p2Control.png', 0)
        cv2.imshow('Control', img4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()

    def Adapthresh(self):
        img1 = cv2.imread('p3Anti A.png', 0)
        cv2.imshow('Anti-A', img1)
        img2 = cv2.imread('p3Anti B.png', 0)
        cv2.imshow('Anti-B', img2)
        img3 = cv2.imread('p3Anti D.png', 0)
        cv2.imshow('Anti-D', img3)
        img4 = cv2.imread('p3Control.png', 0)
        cv2.imshow('Control', img4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()

    def Fill_holes(self):
        img1 = cv2.imread('p4Anti A.png', 0)
        cv2.imshow('Anti-A', img1)
        img2 = cv2.imread('p4Anti B.png', 0)
        cv2.imshow('Anti-B', img2)
        img3 = cv2.imread('p4Anti D.png', 0)
        cv2.imshow('Anti-D', img3)
        img4 = cv2.imread('p4Control.png', 0)
        cv2.imshow('Control', img4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()
